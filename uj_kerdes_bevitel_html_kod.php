...
if (!$celoldal=="user_ell_keret.php") { ?>
  ...
  <br><table border="0" cellpadding="10" colspec="c200" units="pixel">
  <tr>
  ...
  <tr>
  <td align="center"><input type="radio" name="mozgas" value="Elejére" <?php if ($mozgas=="Elejére"){print "checked";} ?> ></td>
  <td align="center"><input type="radio" name="mozgas" value="Vissza" <?php if ($mozgas=="Vissza"){print "checked";} ?>></td>
  <td align="center"><input type="radio" name="mozgas" value="Tovább" <?php if ($mozgas=="Tovább"){print "checked";} ?>></td>
  <td align="center"><input type="radio" name="mozgas" value="Végére" <?php if ($mozgas=="Végére"){print "checked";} ?>></td>
  <td align="center"><input type="radio" name="mozgas" value="Kész" <?php if ($mozgas=="Kész"){print "checked";} ?>></td>
  <td align="center"><input type="radio" name="mozgas" value="Kérdés_törlése" 
                                                          <?php if ($mozgas=="Kérdés_törlése"){print "checked";} ?>></td>
  </tr>
  </table>
  <?php 
